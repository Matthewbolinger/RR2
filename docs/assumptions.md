...
- The four generated photographs are atmospheric editorial brand images, not project evidence. Each relevant page says so.
...
- The Projects hero uses the user-approved finished-landscaping version of the Tudor-home project photo, with a manicured lawn, defined dark mulch beds, clean edging, and restrained foundation plantings. The original project photo remains archived alongside the production derivatives.
