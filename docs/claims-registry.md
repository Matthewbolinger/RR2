...
| Claim | Status | Source | Review |
| --- | --- | --- | --- |
| Barrington, Illinois | Verified | Current website, BBB, GAF | Recheck before launch |
| Serves the Greater Chicago area | Client-confirmed operating market | Client confirmation, July 30, 2026 | Confirm exact city/ZIP list and exceptions for Google Business Profile |
| (224) 500-6825 | Verified | Current website, BBB, GAF | Submit real call test |
| info@raccoonrestoration.com | Verified | Current website | Submit real email test |
| Illinois Roofing License #104.020040 | Verified | Current website, BBB, GAF | Confirm active status before launch |
...
| --- | --- | --- |
| Insured | Awaiting verification | Current certificate and approved disclosure |
| Bonded | Awaiting verification | Bond evidence |
| GAF Certified | Verified external profile; not promoted | Current certificate and logo-use approval |
| Financing available | Awaiting verification | Current program documents |
| Warranty-backed | Awaiting verification | Written terms |
| Five-star / top-rated | Awaiting verification | Dated approved platform data |
...
1. Record exact proposed wording.
2. Attach a source and effective date.
3. Identify claim owner and expiration/review date.
4. Obtain legal, operational, or brand approval where relevant.
5. Change status to approved.
6. Publish from centralized data.
7. Recheck before expiration.

No gated claim should be hardcoded into a page component.
